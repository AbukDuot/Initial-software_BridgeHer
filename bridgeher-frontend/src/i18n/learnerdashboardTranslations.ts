...
const learnerDashboardTranslations: Record<LangKey, LearnerTranslations> = {
  ...
  ar: {
    ...
    reminders: {
      title: "التذكيرات",
      add: "إضافة تذكير",
      placeholder: "أدخل تذكيرا جديدا...",
      done: "تم",
      remove: "حذف",
      empty: "لا توجد تذكيرات بعد - اضيفي واحدة ادناه!",
    },
    calendar: {
      title: "التقويم الخاص بكِ",
      desc: "شاهدي مواعيد جلساتك ودوراتك.",
      note: "يمكنك ربط هذا التقويم بحسابك في Google لمزامنة الجلسات تلقائيا.",
    },
    quotes: [
      "خطوة صغيرة كل يوم تصنع فرقا كبيرا.",
      "التعلم رحلة وليست سباقا.",
      "الثبات يتفوق على الحدة.",
      "مستقبلك يبنى بما تفعلينه اليوم.",
    ],
  },
};
